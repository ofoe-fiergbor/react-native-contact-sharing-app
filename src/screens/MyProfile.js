    ...
    return (
        <View style={styles.container}>
            <View style={styles.profileContainer}>
                <Image source={require('../images/man-in-red-jacket-1681010.jpg')} style={styles.profileImage} />
                <View>
                    <Text style={{ fontWeight: 'bold', fontSize: 17 }}>Staw Hat Luffy</Text>
            ...
            <View>
                ...
                <View style={styles.itemContainer}>
                    ...
                    <Text style={styles.itemText}>straw.hat@codetrain.com</Text>
                </View>
                <View style={styles.itemContainer}>
